...
public abstract class Brix
{
    ...
    /**
     * Constructs a URL to the current page. This method can only be called within an active wicket
     * request because it relies on the {@link RequestCycle} threadlocal.
     * 
