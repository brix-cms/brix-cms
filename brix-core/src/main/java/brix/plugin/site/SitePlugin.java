...
public class SitePlugin implements SessionAwarePlugin
{
	...
	static class WebDAVRulesTab extends AbstractWorkspaceTab
	{
	...
	private final class WebDavActionHandler extends AbstractActionHandler
	{
		...
		public void afterWorkspaceMove(String srcAbsPath, String destAbsPath) throws RepositoryException
		{
			...
			// check if the item had extension before renaming. This is used to handle special case when coda creates 
