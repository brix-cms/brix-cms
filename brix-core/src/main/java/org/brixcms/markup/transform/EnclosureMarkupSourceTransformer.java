 ...
 * <p/>
 * It will resolve the enclosure child elements based on either "brix:tile id"
 * or wicket:id attributes. You can reference wicket components within the tile
 * using the 'child' attribute and a comma separated path.
 * <p/>
 * e.g. where the tile has the wicket component title as a child of wrapper
 * &lt;wicket:enclosure child="mytile,wrapper,title"&gt; &lt;brix:tile
 * id="mytile" /&gt; &lt;/wicket:enclosure&gt;
 * <p/>
 * TODO: - investigate if it is possible to have commas in brix:tile id or
 * wicket:id as this would break id matching - investigate if this works with
 * wicket auto-tags
 * 
...
public class EnclosureMarkupSourceTransformer extends MarkupSourceTransformer {
	...
	/**
	 * Replaces the supplied enclosure child tag with the actual resolved comma
	 * separated component path
	 * 
	 * @param enclosure
	 * @param children
	...
	/**
	 * Inspects the current tag and determine if it is one of the required child
	...
	/**
	 * Updates the list of remaining child components to find and the list of
	 * already found tags which represent them
	 * 
	 * @param tag
	 * @param children
	 * @param enclosureChildTags
