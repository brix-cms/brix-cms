...
public abstract class AbstractWorkspaceManager implements WorkspaceManager
{
	...
	protected void setCachedAttribute(String workspaceId, String key, String value)
	{
		...
		if (value != null)
		{
			Map<String, String> workspaceAttributes = workspaceToWorkspaceAttributesMap.get(workspaceId);
	...
	protected synchronized void removeCachedWorkspaceAttributes(String workspaceId)
	{
		...
		for (Iterator<Entry<AttributeKeyAndValue, Set<String>>> i = attributeToWorkspaceListMap.entrySet().iterator(); i
				.hasNext();)
		{
	...
	public synchronized List<Workspace> getWorkspacesFiltered(Map<String, String> workspaceAttributes)
	{
		...
		else
		{
			...
			{
				AttributeKeyAndValue keyAndValue = new AttributeKeyAndValue(entry.getKey(), entry.getValue());
	...
	abstract protected void setAttribute(String workspaceId, String attributeKey, String attributeValue)
